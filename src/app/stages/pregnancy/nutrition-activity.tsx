...
const topic = topics.find(t => t.id === 'nutrition-activity');
const topicBlogPosts = blogPosts.filter(post => post.relatedTopics.includes('nutrition-activity'));
...
export default function NutritionActivityTopic() {
