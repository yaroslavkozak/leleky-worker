...
const topic = topics.find(t => t.id === 'baby-development');
const topicBlogPosts = blogPosts.filter(post => post.relatedTopics.includes('baby-development'));
...
export default function BabyDevelopmentTopic() {
