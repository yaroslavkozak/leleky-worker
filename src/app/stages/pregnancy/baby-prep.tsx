...
const topic = topics.find(t => t.id === 'baby-prep');
const topicBlogPosts = blogPosts.filter(post => post.relatedTopics.includes('baby-prep'));
...
export default function BabyPrepTopic() {
