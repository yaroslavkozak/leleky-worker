...
const topic = topics.find(t => t.id === 'mom-state');
const topicBlogPosts = blogPosts.filter(post => post.relatedTopics.includes('mom-state'));
...
export default function MomStateTopic() {
