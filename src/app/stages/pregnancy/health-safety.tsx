...
const topic = topics.find(t => t.id === 'health-safety');
const topicBlogPosts = blogPosts.filter(post => post.relatedTopics.includes('health-safety'));
...
export default function HealthSafetyTopic() {
